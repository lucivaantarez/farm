...
getgenv().sailorPieceConfig = {  
    ...
    AUTO_FARM = { "Great Mage Boss", "Cosmic Being", "The World Boss", "True Manipulator Boss", "Strongest Shinobi Boss", "Corrupted Knight Boss" },  -- Auto farm ascend/quest/weapon bosses 
