...
getgenv().sailorPieceConfig = {  
    ...
    AUTO_FARM = { "Great Mage Boss", "Cosmic Being Boss", "The World Boss", "True Manipulator Boss", "Strongest Shinobi Boss", "Corrupted Knight Boss", "Yamato"},  -- Auto farm ascend/quest/weapon bosses 
